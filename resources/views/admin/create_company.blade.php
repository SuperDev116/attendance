                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        @csrf
                            ...
                            <div class="col-md-12 col-sm-12  form-group has-feedback">
                                <div class="d-flex">
                                    <input type="text" class="form-control has-feedback-left" id="zip1" name="zip1" placeholder="000" required="required" size="4" maxlength="3">                   
                                    <input type="text" class="form-control has-feedback-left" id="zip2" name="zip2" placeholder="0000" required="required" onKeyUp="AjaxZip3.zip2addr('zip1','zip2','pref','addr','str');" size="5" maxlength="4">                            
                                </div>
                                <span class="fa fa-filter form-control-feedback left" aria-hidden="true"></span>
                            </div>

                            <div class="col-md-12 col-sm-12  form-group has-feedback">
                                <input type="tel" class="form-control has-feedback-left" id="pref" name="pref" placeholder="東京都" required="required">
                                <span class="fa fa-building form-control-feedback left" aria-hidden="true"></span>
                            </div>
                            <div class="col-md-12 col-sm-12  form-group has-feedback">
                                <input type="tel" class="form-control has-feedback-left" id="addr" name="addr" placeholder="品川区" required="required">
                                <span class="fa fa-building form-control-feedback left" aria-hidden="true"></span>
                            </div>
                            <div class="col-md-12 col-sm-12  form-group has-feedback">
                                <input type="tel" class="form-control has-feedback-left" id="str" name="str" placeholder="0-0-0" required="required">
                                <span class="fa fa-building form-control-feedback left" aria-hidden="true"></span>
                            </div>
