            ...
            <div class="col-lg-5">
                <div class="bg-primary rounded h-100 d-flex align-items-center p-5 wow zoomIn" data-wow-delay="0.9s">
                    <form action="{{ route('otoiawase') }}">
                        <div class="row g-3">
                            <div class="col-xl-12">
                                <input type="text" name="name" class="form-control bg-light border-0" placeholder="名前" style="height: 55px;">
                            </div>
                            <div class="col-12">
                                <input type="email" name="email" class="form-control bg-light border-0" placeholder="Email" style="height: 55px;">
                            </div>
                            <div class="col-12">
                                <input type="hidden" name="subject" class="form-control border-0 bg-light px-4" placeholder="主題" style="height: 55px;" value="見積もり依頼">
                            </div>
                            <div class="col-12">
                                <textarea name="message" class="form-control bg-light border-0" rows="3" placeholder="メッセージ"></textarea>
                            </div>
                            <div class="col-12">
